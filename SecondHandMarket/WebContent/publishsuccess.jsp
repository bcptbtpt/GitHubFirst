...
<%
		...
		//String pricre=request.getParameter("price").trim();
		...
		stmt = con.createStatement();
		    if((goods!=null)&&(number!=null)&&(bargain!=null)&&(category!=null)&&(intro!=null)&&(price!=0)&&(cost!=0)){
	 				stmt.executeUpdate("insert into shangpin values(0,'"+goods+"','"+ price + "','"+ cost + "','"+number + "','"+ bargain + "','"+category + "','"+ intro + "','"+ username + "');");
				%>
				发布成功!!三秒钟后自动转到主页面！！！<br>
				如果没有跳转，请点击<a href="interface.jsp">这里</a>！！！
				<span style="font-size:24px;"><meta http-equiv="refresh" content="3;URL=interface.jsp"> </span>
<% 
			}else {
				out.print("信息不完整");
			}
